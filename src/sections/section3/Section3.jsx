...
import criador from "../../assets/foto-eu.png";
        ...
        <div className={styles.content}>
          <div className={styles.left}>
            ...
            <div className={styles.info}>
              ...
              <p>
                Clique abaixo e garanta o seu acesso por um ano a um dos
                melhores Close Friends (stories de melhores amigos) do Brasil.
              </p>
